...
export BUILD_TAG="AIOT3588A_stable_${set_rootfs}"
...
wget -c https://github.com/yifengyou/aiot-3588a/releases/download/linux_stable_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/linux_stable_kernel/config-7.0-kdev
ls -alh config-7.0-kdev
md5sum config-7.0-kdev

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/linux_stable_kernel/System.map-7.0-kdev
ls -alh System.map-7.0-kdev
md5sum System.map-7.0-kdev

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/linux_stable_kernel/rk3588-aiot3588a.dtb
ls -alh rk3588-aiot3588a.dtb
md5sum rk3588-aiot3588a.dtb

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/linux_stable_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz

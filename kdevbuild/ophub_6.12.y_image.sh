...
export BUILD_TAG="AIOT3588A_6.12.y_${set_rootfs}"
...
wget -c https://github.com/yifengyou/aiot-3588a/releases/download/ophub_6.12.y_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/ophub_6.12.y_kernel/config-6.12.y-kdev
ls -alh config-6.12.y-kdev
md5sum config-6.12.y-kdev

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/ophub_6.12.y_kernel/System.map-6.12.y-kdev
ls -alh System.map-6.12.y-kdev
md5sum System.map-6.12.y-kdev

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/ophub_6.12.y_kernel/rk3588-aiot3588a.dtb
ls -alh rk3588-aiot3588a.dtb
md5sum rk3588-aiot3588a.dtb

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/ophub_6.12.y_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz

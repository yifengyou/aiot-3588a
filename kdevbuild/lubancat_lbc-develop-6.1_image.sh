...
export BUILD_TAG="AIOT3588A_lbc-develop-6.1_${set_rootfs}"
...
wget -c https://github.com/yifengyou/aiot-3588a/releases/download/lubancat_lbc-develop-6.1_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/lubancat_lbc-develop-6.1_kernel/config-6.1-kdev
ls -alh config-6.1-kdev
md5sum config-6.1-kdev

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/lubancat_lbc-develop-6.1_kernel/System.map-6.1-kdev
ls -alh System.map-6.1-kdev
md5sum System.map-6.1-kdev

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/lubancat_lbc-develop-6.1_kernel/rk3588-aiot3588a.dtb
ls -alh rk3588-aiot3588a.dtb
md5sum rk3588-aiot3588a.dtb

wget -c https://github.com/yifengyou/aiot-3588a/releases/download/lubancat_lbc-develop-6.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
